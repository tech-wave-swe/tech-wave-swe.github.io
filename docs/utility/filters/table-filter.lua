...
function generate_tabularray(tbl)
	...
	local result = pandoc.List:new{pandoc.RawBlock("latex", '\\noindent\\begin{center}\\begin{longtable}\\centering\\caption{' .. caption .. '}\\begin{'..table_class..'}{width=1\\linewidth,colspec={'..col_specs_latex..'}}')}
	...
	result = result .. pandoc.List:new{pandoc.RawBlock("latex", '\\end{'..table_class..'}\\end{longtable}\\end{center}')}
