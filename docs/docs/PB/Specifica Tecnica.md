...
È un _pattern architetturale_ con lo scopo di separare le responsabilità dei componenti di un’applicazione. Come già indicato nella sezione _/Architettura Logica/_ è stato utilizzato per l’implementazione dell’intero %%applicativo|applicativo%% in quanto era necessario coordinare le componenti di dati e logica e interfaccia utente.
