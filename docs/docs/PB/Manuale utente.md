...
| ---------- | -------- | --------------------------- | ------------------- | ------------- | ------------------- |
| 17/04/2025 | 1.0.0    | Sezione Gestione errori     | Marcon Giulia       | 18/04/2025    | Piola Andrea        |
| 17/04/2025 | 0.3.0    | Sezione Avvio               | Dal Bianco Riccardo | 17/04/2025    | Marcon Giulia       |
| 15/04/2025 | 0.2.0    | Sezione Utilizzo            | Marcon Giulia       | 16/04/2025    | Dal Bianco Riccardo |
...
| Node.js            | last                 | Ambiente di esecuzione JavaScript necessario per il backend dell'estensione    | [Download Node.js](https://nodejs.org/en)        |
...
<img src="/img/Screenshot/Explorer.jpg" alt="Sezione Explorer" data-width="70%" />
...
Se la struttura delle cartelle e dei file sarà visibile nella sezione **Explorer** di %%Visual Studio Code|vscode%% (Icona dei file nella barra laterale sinistra) il progetto è aperto correttamente e l’estensione è pronta per essere utilizzata nel contesto di lavoro attivo.
...
1. **Model**:
   Permette di selezionare, tramite un menù a tendina, il modello %%LLM|llm%% da utilizzare come predefinito per le funzionalità dell'estensione.
...
3. **Embedding Model**:
   Permette di selezionare, tramite un menù a tendina, il modello da utilizzare per la generazione degli embedding per la rappresentazione vettoriale dei requisiti
   Il menù propone una lista di modelli preinstallati localmente tramite %%Ollama|ollama%%.
...
9. **Temperature**:
   ...
   Esempi: - 0.2 -> Risposte precise e ripetibili. - 0.7 -> Risposte più libere e diversificate.

#### Configurazioni del progetto

<img src="/img/Screenshot/Config.jpg" alt="Configurazioni specifiche" data-width="70%" />
...
Dettagli delle impostazioni disponibili:
...
Attenzione: questa azione è irreversibile e comporta la perdita di eventuali collegamenti o modifiche manuali effettuate.
...
Durante l’utilizzo dell’estensione possono comparire diversi messaggi di errore. Di seguito si trova un elenco dei più comuni, con una breve descrizione e cosa fare per risolverli.
